...
assert.match(generated, /class="rail-edition"/);
assert.match(generated, /class="command-edition"/);
...
assert.match(dashboardCss, /--paper:\s*#090a0c/);
assert.match(dashboardCss, /\.site-header\s*\{[^}]*position:\s*fixed/);
