...
assert.doesNotMatch(generated, /class="team-mark"/);
assert.match(generated, /class="team-meta"/);
...
assert.match(dashboardCss, /--faceit:\s*#ff5500/);
assert.match(dashboardCss, /\.site-header\s*\{[^}]*position:\s*relative/);
assert.match(dashboardCss, /\.legacy-brand img\s*\{[^}]*width:\s*176%/);
assert.match(dashboardCss, /\.ranking-table tbody\s*\{[^}]*display:\s*grid/);
assert.match(dashboardCss, /\.ranking-table tbody\s*\{[^}]*grid-template-columns:\s*1fr/);
